    ...
    <>
      ...
      <main className="min-w-[320px] max-w-[1536px] mx-auto">
        <section className="flex flex-col gap-y-6 px-12 py-16 items-center bg-white">
          <h1 className="uppercase font-semibold text-5xl">Jane Bloglife</h1>
          <p>
            Welcome to the blog of{" "}
            <span className="bg-black p-1 text-white">Jane&apos;s world</span>
          </p>
        </section>
        ...
        <div className="p-8 flex flex-col gap-8 lg:flex-row lg:justify-between">
          ...
          <div className="flex flex-col gap-y-8 lg:w-[35%]">
            ...
            <section>
              ...
              <ul className={`${openSans.className} bg-white divide-y`}>
                {popularPosts?.map(
                  ({ id, popularPostTitle, description, img }) => (
                    <PopularPost
                      key={id}
            ...
            <section>
              ...
              <WhiteContainer>
                <form className={`${openSans.className} flex flex-col gap-y-4`}>
                  <p>
